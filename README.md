...
6. Tell bspatch to patch thXX.exe.steam and save it as thXX.exe, using thXX.bdf.
    ...
    - example 4 (Linux):
        - `bspatch "~/.local/share/Steam/steamapps/common/th12/th12.exe.steam" "~/.local/share/Steam/steamapps/common/th12/th12.exe" "~/.local/share/Steam/steamapps/common/th12/th12.bdf"`
